...
class AplikasiRekomendasiBuku:
    def _init_(self, root):
        ...
        self.label_login = tk.Label(self.halaman_login, text="Masukkan akun anda", font=("Courier", 35, "bold"), bg="#ffeeea", fg="#ff8b67")
        self.canvas_login.create_window(screen_width // 2, screen_height // 2 - 210, window=self.label_login)

        self.label_username = tk.Label(self.halaman_login, text="Username:", font=("Courier", 25, "bold"), bg="#ffeeea", fg="#ff8b67")
        self.canvas_login.create_window(screen_width // 2, screen_height // 2 - 150, window=self.label_username)
        
        self.username_entry_login = tk.Entry(self.halaman_login)
        self.canvas_login.create_window(screen_width // 2, screen_height // 2 - 100, window=self.username_entry_login)

        self.label_password = tk.Label(self.halaman_login, text="Password:", font=("Courier", 25, "bold"), bg="#ffeeea", fg="#ff8b67")
        self.canvas_login.create_window(screen_width // 2, screen_height // 2 - 50, window=self.label_password)
        
        self.password_entry_login = tk.Entry(self.halaman_login, show="*")
        self.canvas_login.create_window(screen_width // 2, screen_height // 2, window=self.password_entry_login)

        self.button_login = tk.Button(self.halaman_login, text="Log in", font=("Courier", 15, "bold"), command=self.login)
        self.canvas_login.create_window(screen_width // 2, screen_height // 2 + 50, window=self.button_login)
        
        self.button_signup = tk.Button(self.halaman_login, text="Sign up", font=("Courier", 15, "bold"), command=self.buka_halaman_signup)
        self.canvas_login.create_window(screen_width // 2, screen_height // 2 + 110, window=self.button_signup)
        ...
        self.label_signup = tk.Label(self.halaman_signup, text="Sign up", font=("Courier", 35, "bold"), bg="#ffeeea", fg="#ff8b67")
        self.canvas_signup.create_window(screen_width // 2, screen_height // 2 - 210, window=self.label_signup)

        self.label_signup_username = tk.Label(self.halaman_signup, text="Username:", font=("Courier", 25, "bold"), bg="#ffeeea", fg="#ff8b67")
        self.canvas_signup.create_window(screen_width // 2, screen_height // 2 - 150, window=self.label_signup_username)
        
        self.username_entry_signup = tk.Entry(self.halaman_signup)
        self.canvas_signup.create_window(screen_width // 2, screen_height // 2 - 100, window=self.username_entry_signup)
    
        self.label_signup_pass = tk.Label(self.halaman_signup, text="Password:", font=("Courier", 25, "bold"), bg="#ffeeea", fg="#ff8b67")
        self.canvas_signup.create_window(screen_width // 2, screen_height // 2 - 50, window=self.label_signup_pass)
        
        self.password_entry_signup = tk.Entry(self.halaman_signup, show="*")
        self.canvas_signup.create_window(screen_width // 2, screen_height // 2, window=self.password_entry_signup)
        
        self.button_sign_up = tk.Button(self.halaman_signup, text="Sign up", font=("Courier", 15, "bold"), command=self.signup)
        self.canvas_signup.create_window(screen_width // 2, screen_height // 2 + 50, window=self.button_sign_up)
        ...
        self.canvas_terimakasih.create_window(screen_width // 2, screen_height // 2 + 220, window=self.tombol_keluar)
